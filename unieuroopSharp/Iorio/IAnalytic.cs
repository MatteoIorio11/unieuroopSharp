...
namespace unieuroopSharp.Iorio
{
    public interface IAnalityc
    {
        ...
        HashSet<IProduct> GetTotalProductsSold();
        /// <summary>
        ...
        int GetQuantitySoldOf(IProduct product);
        /// <summary>
        ...
        int GetQuantitySoldOf(IProduct product, Predicate<DateTime> date);
        /// <summary>
        ...
        Dictionary<IProduct, int> GetOrderedByCategory(Predicate<Product.Category> categories);
        /// <summary>
        ...
        HashSet<IProduct> GetProductByDate(Predicate<DateTime> date);
        /// <summary>
